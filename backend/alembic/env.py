...
Uses async PostgreSQL engine from app.database and imports all models
...
# Convert asyncpg URL to a sync psycopg2 URL for offline mode,
# but keep asyncpg for online (run_async_migrations).
