...
import { Atom, AlertTriangle, CheckCircle, XCircle, Info, Loader2 } from 'lucide-react';
...
export default function QuantumPage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      const data = await api.quantum.readiness();
      setReadiness(data as QuantumReadiness);
    } catch {
      usedFallback = true;
